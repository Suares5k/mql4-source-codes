...
extern simnao AtivaDonchian = NAO; //ATIVAR DONCHIAN
...
//----
 ...
 SetIndexStyle(11,DRAW_NONE,EstiloDonChian,LarguraDonchian,CorDonChianAcima);
   SetIndexBuffer(11,ExtMapBuffer1);
   SetIndexStyle(12,DRAW_NONE,EstiloDonChian,LarguraDonchian,CorDonChianAbaixo);
      ...
      if(Time[i] > dfrom)
        {
         ...
         up_frog, dn_frog, up_val, dn_val, up_adx, dn_adx, fora_banda_up, fora_banda_dn, up_fox, dn_fox, up_skunk, dn_skunk, up_sg, dn_sg ;
         double up1 = 0, dn1 = 0;
         double up2 = 0, dn2 = 0;
         double up3 = 0, dn3 = 0;
         double up4 = 0, dn4 = 0;
...
//====================================================================================================================================
           if(Trend)
           {
           trend = iCustom(Symbol(),Period(),"Trend",trendPeriod,i);
           }
//====================================================================================================================================
...
//====================================================================================================================================
         ...
         if(
            ...
            && up_oozaru && fora_banda_up && up_fox && up_skunk
         ...
         if(
            ...
            && dn_oozaru && fora_banda_dn && dn_fox && dn_skunk
